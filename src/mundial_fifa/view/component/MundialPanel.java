...
public class MundialPanel extends JPanel {
    ...
    public MundialPanel() {
        ...
        JLabel lblTitulo = new JLabel("Gestión de Mundiales");
        lblTitulo.setFont(new Font("Arial", Font.BOLD, 22));
        add(lblTitulo, BorderLayout.NORTH);

        String[] columnas = { "ID", "Año", "País Anfitrión" };
    ...
    public Mundial mostrarModalFormulario(Mundial objetivo) {
        Window ventanaPadre = SwingUtilities.getWindowAncestor(this);
        MundialFormDialog modal = new MundialFormDialog((Frame) ventanaPadre, objetivo);
        modal.setVisible(true);
        return modal.getMundialProcesado();
    }
}
