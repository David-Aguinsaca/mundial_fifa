...
public class ConfederacionPanel extends JPanel {
    ...
    public ConfederacionPanel() {
        ...
        String[] columnas = { "ID", "Nombre", "Siglas", "ID Continente", "Estado", "Creación", "Modificación" };
        ...
        tablaDatos.getColumnModel().getColumn(4).setCellRenderer(new EstadoCeldaRenderer());
        tablaDatos.getColumnModel().getColumn(5).setCellRenderer(new FechaCeldaRenderer());
        tablaDatos.getColumnModel().getColumn(6).setCellRenderer(new FechaCeldaRenderer());
    ...
    public Confederacion mostrarModalFormulario(Confederacion objetivo, DefaultComboBoxModel<?> continentesModelo) {
        Window ventanaPadre = SwingUtilities.getWindowAncestor(this);
        ConfederacionFormDialog modal = new ConfederacionFormDialog((Frame) ventanaPadre, objetivo, continentesModelo);
        modal.setVisible(true);
        return modal.getConfederacionProcesada();
    }
}
